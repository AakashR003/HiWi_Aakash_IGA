...
## Overview
This folder is a part of HiWi (Student Research Assistant) work  in **Isogeometric Analysis** using the **Kratos Multiphysics** framework. It contains multiple case studies and validations for for IGA elements.
